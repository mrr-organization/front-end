<template>
    ...
    <div class="flex justify-end mt-2 max-w-screen-2xl">
        <button @click="deleteAllNotification" v-show="listNotification.length != 0" class="p-1 text-lg font-medium text-white uppercase bg-red-500 rounded-lg "  ><font-awesome-icon icon="xmark"  size="xl" /> ลบแจ้งเตือนทั้งหมด  </button>
    </div>
