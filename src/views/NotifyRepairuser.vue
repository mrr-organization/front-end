...
<div class="mx-auto mt-24 max-w-7xl " style="background-color: #FEF1E6;">
  ...
  <div class="max-w-4xl mx-auto mt-3">
    <div>
     ...
     <textarea class="w-full h-28 ring-1 ring-black" placeholder="ใส่รายละเอียดสถานที่เรื่องร้องเรียน"></textarea>
    </div>
  </div>
  <div class="max-w-4xl mx-auto mt-3">
    <div>
     <h3 class="text-left" style="color:#312A21">รายละเอียด</h3>
     <textarea class="w-full h-28 ring-1 ring-black" placeholder="ใส่รายละเอียด / อธิบายเพิ่มเติม"></textarea>
    </div>
  </div>
  <div class="max-w-4xl mx-auto mt-3 ">
    <div class="flex flex-col">
     <h3 class="text-left" style="color:#312A21">รูปภาพประกอบ</h3>
          ...
          <input type="file" style="visibility:hidden;" id="files" accept="image/*" multiple="multiple" @change="previewMultiImage" class="self-end">
  ...
  <div>
    <ButtonCom msg = "ยืนยัน" class="p-2 mt-6 mb-2 text-black w-28"  style="background-color: #F9D5A7;"></ButtonCom>
  </div>
  </div>
</template>
